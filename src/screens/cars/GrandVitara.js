...
function GrandVitara() {
  ...
  return (
    <>
      <Helmet>
        <title>
          Maruti Suzuki Grand Vitara 2025 Discounts and festive Offers - Get
          Exciting Savings on the Premium SUV at RKS Motor
        </title>
        <meta
          name="title"
          content=" Maruti Suzuki Grand Vitara 2025 Discounts and festive Offers - Get Exciting Savings on the Premium SUV at RKS Motor"
        />
        <meta
          name="description"
          content="The Grand Vitara brings luxury and power together. Avail 2025 Discounts and festive Offers on this premium SUV from Maruti Suzuki Nexa. With enhanced performance and style, make the Grand Vitara yours today with limited-time discounts."
        />
        <meta
          name="keywords"
          content="Maruti Suzuki Grand Vitara offer, Nexa Grand Vitara 2025 Discounts and festive Offers, SUV discount, premium SUV deals, Nexa Grand Vitara savings , 2025 Discounts and festive Offers.       "
        />
        {/*  <meta name="author" content="Broaddcast" />
          ...
          <meta
          property="og:title"
          content="Nexa  Grand Vitara Car on Road Price & Offers in Hyderabad| Saboo Nexa"
          />
          <meta
          property="og:description"
          content="Nexa  Grand Vitara 2024 car price starts at 8.87 lakh, mileage of 26.8 km/l. Get Nexa  Grand Vitara specifications & features. Best offers on  Grand Vitara car, low EMI, low down-payment. Call now 9848898488"
          />
          <meta
          property="og:image"
...
const Variant = () => {
  const [price, setPrice] = useState("10,80,000");
  return (
      ...
      <div className="container py-20 mx-auto bg-black bg-opacity-10 ">
        <div className="grid space-y-3 md:grid-cols-3 md:space-y-0">
          <div className="mx-auto space-y-3 md:mx-0">
            ...
            >
              {/* 4th */}
              <option value="10,80,000">Smart Hybrid MT Sigma </option>
              <option value="12,20,000">Smart Hybrid MT Delta </option>
              <option value="14,01,000">Smart Hybrid MT Zeta </option>
              <option value="15,51,000">Smart Hybrid MT Alpha </option>
              <option value="15,67,000">Smart Hybrid MT Alpha (DT)</option>
              {/* 3rd set */}
              <option value="13,60,000">Smart Hybrid AT Delta </option>
              <option value="15,41,000">Smart Hybrid AT Zeta </option>
              <option value="16,91,000">Smart Hybrid AT Alpha </option>
              <option value="17,07,000">Smart Hybrid AT Alpha (DT)</option>
              {/* 2nd set */}
    ...
    <div className="relative  bg-black flex flex-col xl:max-h-[80vh] overflow-hidden">
      ...
      >
        <source
          ...
          src="https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/grand-vitara/brand-title-video/end-shot-grand-vitara.mp4"
        />
      </video>
    </div>
  );
      ...
      <div className="lg:h-[60vh] overflow-hidden">
        ...
        >
          <source
            ...
            src="https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/grand-vitara/brand-philosophy/06_rear_3_.mp4"
            type="video/mp4"
          />
        </video>
      </div>
    ...
    <>
      ...
      <div className="container relative flex flex-col items-center justify-center mx-auto -mt-10">
        <img
          ...
          src="https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/nexa-website-grandvitara/safety/car-image.webp?la=en&hash=828451D0EB73F2B9AB621EBDE6D35504"
