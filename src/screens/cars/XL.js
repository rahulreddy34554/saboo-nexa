...
function XL() {
  ...
  return (
    <>
      <Helmet>
        <title>
          Maruti Suzuki XL6 2025 Discounts and festive Offers - Limited-Time
          Discounts on the Premium MPV at RKS Motor
        </title>
        <meta
          name="title"
          content="Maruti Suzuki XL6 2025 Discounts and festive Offers - Limited-Time Discounts on the Premium MPV at RKS Motor"
        />
        <meta
          name="description"
          content="Take home the spacious and stylish Maruti Suzuki XL6 with 2025 Discounts and festive Offers! Enjoy amazing savings on this premium MPV, designed for comfort and adventure. Visit Nexa today for these exclusive deals!"
        />
        <meta
          name="keywords"
          content="Maruti Suzuki XL6 offer, 2025 Discounts and festive Offers on XL6, Nexa MPV offers, XL6 discounts, premium MPV 2025 festive offer, 2025 Discounts and festive Offers."
        />
          ...
          <SwiperSlide className="">
            <div className="relative w-full ">
              <img
                ...
                src="https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/xl6/brand-highlights/img4.webp"
          ...
          <SwiperSlide className="relative">
            <div className="relative w-full ">
              <img
                ...
                src="https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/xl6/brand-highlights/img1.webp"
                alt="360 View Camera"
              />
              <div className="bottom-0 w-full p-2 text-xl bg-white bg-opacity-50 md:absolute lg:py-4 lg:text-3xl">
                360 View Camera
          ...
          <SwiperSlide className="relative">
            <div className="relative w-full ">
              <img
                ...
                src="https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/xl6/brand-highlights/img2.webp"
          ...
          <SwiperSlide className="relative">
            <div className="relative w-full ">
              <img
                ...
                src="https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/xl6/brand-highlights/img3.webp"
              ...
              <SwiperSlide className="relative">
                <div className="w-full lg:px-20">
                  <img
                    ...
                    src="https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/xl6/features/1170x521-images-cruise-controllll-webp.webp?la=en&hash=76C6449079A81FE28FBE149B84135EC8"
                    alt=" Cruise Control"
                    className=""
                  />
              ...
              <SwiperSlide className="">
                <div className="w-full lg:px-20">
                  <img
                    ...
                    src="https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/xl6/features/1170x521-cup-holder.webp?la=en&hash=E87C6D5C854A4B254F5F8443A8C9A1F3"
              ...
              <SwiperSlide className="relative">
                <div className="w-full lg:px-20">
                  <img
                    ...
                    src="https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/xl6/features/1170x521-uv-cut-glass.webp?la=en&hash=00663188D95432FF6CAB3144D66B57F5"
                    alt="UV Cut Glass"
                  />
                  <div className="w-full px-4 pt-4 text-left text-white md:absolute bottom-4">
              ...
              <SwiperSlide className="relative">
                <div className="w-full lg:px-20">
                  <img
                    ...
                    src="https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/xl6/features/1170x521-avn-smartplay.webp?la=en&hash=0B51A7B11DBF2563E11C9EF484E908C"
                    alt="SmartPlay Pro"
                    className=""
                  />
                  <div className="w-full px-4 pt-4 text-left text-white md:absolute bottom-4">
              ...
              <SwiperSlide className="relative">
                <div className="w-full lg:px-20">
                  <img
                    ...
                    src="https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/xl6/features/1170x521-fog-light.webp?la=en&hash=bc1qre8jdw2azrg6tf49wmp652w00xltddxmpk98xp"
                    alt=" LED FOG Lamps"
                    className=""
                  />
                  <div className="w-full px-4 pt-4 text-left text-white md:absolute bottom-4">
              ...
              <SwiperSlide className="relative">
                <div className="w-full lg:px-20">
                  <img
                    ...
                    src="https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/xl6/features/1170x521-rear-ac-in-second-row.webp?la=en&hash=F5A9F40496470BFB869D62E2743066E8"
                    alt="   2nd Row AC "
                    className=""
                  />
                  <div className="w-full px-4 pt-4 text-left text-white md:absolute bottom-4">
              ...
              <SwiperSlide className="relative">
                <div className="w-full lg:px-20">
                  <img
                    ...
                    src="https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/xl6/features/1170x521-cabin-foot-almp.webp?la=en&hash=5DAB07423DB329686C3158E6407D2781"
              ...
              <SwiperSlide className="relative">
                <div className="w-full lg:px-20">
                  <img
                    ...
                    src="https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/xl6/features/1170x521-puddle-lamp.webp?la=en&hash=50E1F6123023BC642A5A07D56D6A0BA9"
              ...
              <SwiperSlide className="relative">
                <div className="w-full lg:px-20">
                  <img
                    ...
                    src="https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/xl6/features/1170x521-roof-end-spoiler.webp?la=en&hash=CC99EC9BC4AC21A2BCFB3DB7A2636685"
              ...
              <SwiperSlide className="relative">
                <div className="w-full lg:px-20">
                  <img
                    ...
                    src="https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/xl6/features/1170x521-instrument-cluster-webp.webp?la=en&hash=BEBEB8110FDADE82419EA461EF6BB932"
              ...
              <SwiperSlide className="relative">
                <div className="w-full lg:px-20">
                  <img
                    ...
                    src="https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/xl6/features/1170x521--orvm.webp?la=en&hash=556F1C024C6D46CF812A6BEAA86A2140"
                    alt="  Auto ORVMs"
                    className=""
                  />
                  <div className="w-full px-4 pt-4 text-left text-white md:absolute bottom-4">
              ...
              <SwiperSlide className="relative">
                <div className="w-full lg:px-20">
                  <img
                    ...
                    src="https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/xl6/features/1170x521-captain-seatsss-webp.webp?la=en&hash=B01B9BAE18CB2C44B6C0882D41DED980"
                    alt="Captain Seats"
                    className=""
                  />
                  <div className="w-full px-4 pt-4 text-left text-white md:absolute bottom-4">
            ...
            >
              ...
              <SwiperSlide className="cursor-pointer">
                <div>
                  <img
                    // src="https://nexaprod6.azureedge.net/-/media/feature/nexawebsitecarbrand/xl6/features/1170x521-avn-smartplay.webp?la=en&hash=2A1B179439073E4976EEF63E0CACD094"
                    src="https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/xl6/features/1170x521-avn-smartplay.webp?la=en&hash=0B51A7B11DBF2563E11C9EF484E908CF"
                    alt=" SmartPlay Pro"
                    className="max-h-24"
                  />
      ...
      <div className="mx-auto lg:container">
        ...
        >
          <SwiperSlide className="">
            <div className="w-full ">
              <img
                ...
                src="https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/xl6/technology/1080x420-smart-hybrid.webp"
          ...
          <SwiperSlide className="">
            <div className="w-full ">
              <img
                ...
                src="https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/xl6/technology/1080x420-ags.webp"
                alt="6-SPEED AT WITH PADDLE SHIFTERS"
                className="relative "
              />
              <div className="w-full pt-4 text-left ">
          ...
          <SwiperSlide className="relative">
            <div className="w-full">
              <img
                ...
                src="https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/xl6/technology/1080x420-smartplay.webp"
                alt="SMARTPLAY PRO"
              />
              <div className="w-full pt-4 text-left ">
                <div className="pb-2 font-medium"> SMARTPLAY PRO</div>
          ...
          <SwiperSlide className="relative">
            <div className="w-full">
              <img
                ...
                src="https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/xl6/technology/1080x420-360-view.webp"
                alt="360 VIEW CAMERA"
              />
              <div className="w-full pt-4 text-left ">
          ...
          <SwiperSlide className="relative">
            <div className="w-full ">
              <img
                src="https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/xl6/technology/1080x420-suzuki-connect.webp"
                alt="SUZUKI CONNECT"
              />
              <div className="w-full pt-4 text-left ">
    ...
    <>
      ...
      <div className="container relative flex flex-col items-center justify-center mx-auto ">
        <img
          ...
          src="https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/xl6/safety/xl6-in-glance_897x_573.webp?la=en&hash=bc1qre8jdw2azrg6tf49wmp652w00xltddxmpk98xp"
              ...
              <SwiperSlide className="relative">
                <div className="w-full lg:px-20">
                  <img
                    ...
                    src="https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/xl6/features/1170x521_safety_airbag.webp?la=en&hash=CABDE2E512A3AF6F649FF85081704C08"
              ...
              <SwiperSlide className="">
                <div className="w-full lg:px-20">
                  <img
                    ...
                    src="https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/xl6/features/1170x521_safety_abs-esp.webp?la=en&hash=F5163CA8AA720F0180C51BEF83DEF5D5"
              ...
              <SwiperSlide className="relative">
                <div className="w-full lg:px-20">
                  <img
                    ...
                    src="https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/xl6/features/1170x521_safety_child-seat.webp?la=en&hash=4B54BA2BA52F2AEBC36D26D3AA7D6715"
              ...
              <SwiperSlide className="relative">
                <div className="w-full lg:px-20">
                  <img
                    ...
                    src="https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/xl6/features/1170x521_safety_abs.webp?la=en&hash=bc1qre8jdw2azrg6tf49wmp652w00xltddxmpk98xp"
                    alt=" ABS with EBD"
                    className=""
                  />
                  <div className="w-full px-4 pt-4 text-left md:text-white md:absolute bottom-4">
              ...
              <SwiperSlide className="relative">
                <div className="w-full lg:px-20">
                  <img
                    ...
                    src="https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/xl6/features/1170x521_safety_heartect.webp?la=en&hash=726EE72E84873DBD7C688525AA254C3D"
            ...
            >
              ...
              <SwiperSlide className="cursor-pointer">
                <div>
                  <img
                    //  src="https://nexaprod5.azureedge.net/-/media/feature/nexawebsitecarbrand/xl6/features/1170x521_safety_heartect.webp?la=en&hash=03F60ADC206C53DEC100F942688ECA07"
                    //  sr="https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/xl6/features/1170x521_safety_heartect.webp?la=en&hash=726EE72E84873DBD7C688525AA254C3D"
                    src="https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/xl6/features/1170x521_safety_heartect.webp?la=en&hash=726EE72E84873DBD7C688525AA254C3D"
                    alt="Heartect Platform"
                    className="max-h-28"
                  />
