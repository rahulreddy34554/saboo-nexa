...
const Jimny = () => {
  ...
  return (
    <>
      <Helmet>
        <title>
          2025 Discounts and festive Offers on Maruti Suzuki Jimny - Get
          Exclusive Discounts on the Adventure-Ready Jimny! at RKS Motor
        </title>
        <meta
          name="title"
          content="2025 Discounts and festive Offers on Maruti Suzuki Jimny - Get Exclusive Discounts on the Adventure-Ready Jimny! at RKS Motor"
        />
        <meta
          name="description"
          content="Unlock incredible 2025 year discounts on the Maruti Suzuki Jimny! Take advantage of special finance options, exchange benefits, and more on this rugged, off-road-ready SUV. Don't miss out on limited-time offers!"
        />
        <meta
          name="keywords"
          content="Maruti Suzuki Jimny offers,  2025 Discounts and festive Offers Jimny, Jimny SUV deals, Maruti Suzuki Nexa offers, off-road SUV offers, Jimny special finance , 2025 Discounts and festive Offers."
        />
      </Helmet>
                  ...
                  <SwiperSlide className="">
                    <div className="w-full lg:px-20">
                      <img
                        ...
                        src="https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/rocky/featuretechnology/interior/1000x500-ar_pk_nexa_jimny_interior_kv_v-1.webp"
                  ...
                  <SwiperSlide className="relative">
                    <div className="w-full lg:px-20">
                      <img
                        ...
                        src="https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/rocky/featuretechnology/interior/1000x500-ar_pk_nexa_jimny_intuitively-designed-controls_v-2.webp"
                  ...
                  <SwiperSlide className="relative">
                    <div className="w-full lg:px-20">
                      <img
                        ...
                        src="https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/rocky/featuretechnology/interior/comfortable-seat-design.webp"
                  ...
                  <SwiperSlide className="relative">
                    <div className="w-full lg:px-20">
                      <img
                        ...
                        src="https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/rocky/featuretechnology/interior/professional-utility-kit.webp"
                  ...
                  <SwiperSlide className="relative">
                    <div className="w-full lg:px-20">
                      <img
                        ...
                        src="https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/rocky/featuretechnology/interior/1000x500-ar-am-jimny-ywd-smart-play-pro-shot-v1-copy.webp"
                        alt="SmartPlay Pro+"
                      />
                      <div className="w-full px-4 pt-4 text-left text-white md:absolute bottom-4">
                  ...
                  <SwiperSlide className="">
                    <div className="w-full lg:px-20">
                      <img
                        ...
                        src="https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/rocky/featuretechnology/exterior/clamshell-bonnet.webp"
                  ...
                  <SwiperSlide className="relative">
                    <div className="w-full lg:px-20">
                      <img
                        ...
                        src="https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/rocky/featuretechnology/exterior/1000x500-ar_sn_nexa_jimny_optimized-bumper_v2.webp"
                  ...
                  <SwiperSlide className="relative">
                    <div className="w-full lg:px-20">
                      <img
                        ...
                        src="https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/rocky/featuretechnology/exterior/practical-drip-rail.webp"
                  ...
                  <SwiperSlide className="relative">
                    <div className="w-full lg:px-20">
                      <img
                        ...
                        src="https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/rocky/featuretechnology/exterior/1000x500-ar_ab_jimny_led_headlamp_with_washer_02-copy.webp"
                  ...
                  <SwiperSlide className="relative">
                    <div className="w-full lg:px-20">
                      <img
                        ...
                        src="https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/rocky/featuretechnology/exterior/alloy.webp"
                        alt="Alloy"
                      />
                      <div className="w-full px-4 pt-4 text-left text-white md:absolute bottom-4">
          ...
          <SwiperSlide className="">
            <div className="w-full ">
              <img
                ...
                src="https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/rocky/brand-persona-variant/1080x420-ar_vk_nexa_jimny-all-grip-pro_v-2.webp"
                alt=" ALL GRIP PRO"
                className="relative "
              />
          ...
          <SwiperSlide className="">
            <div className="w-full ">
              <img
                ...
                src="https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/rocky/brand-persona-variant/1080x420_ar_bp_nexa_jimny_chassis_shot_02.webp"
          ...
          <SwiperSlide className="relative">
            <div className="w-full ">
              <img
                ...
                src="https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/rocky/brand-persona-variant/1080x420-ar_bp_nexa_jimny_3_link_suspension_02.webp"
          ...
          <SwiperSlide className="relative">
            <div className="w-full">
              <img
                ...
                src="https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/rocky/brand-persona-variant/1080x420-ar_bp_nexa_jimny_engine_03.webp"
