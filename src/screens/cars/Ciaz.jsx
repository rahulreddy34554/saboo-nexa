...
function Ciaz() {
  ...
  return (
    <>
      <Helmet>
        <title>
          Maruti Suzuki Ciaz 2025 Discounts and festive Offers - Unbeatable
          Discounts on the Premium Sedan at RKS Motor
        </title>
        <meta
          name="title"
          content=" Maruti Suzuki Ciaz 2025 Discounts and festive Offers - Unbeatable Discounts on the Premium Sedan at RKS Motor"
        />
        <meta
          name="description"
          content="Discover premium style and comfort with Maruti Suzuki Ciaz. Take advantage of exclusive 2025 Discounts and festive Offers on this sophisticated sedan, available only at Nexa showrooms. Drive luxury home today with special discounts!"
        />
        <meta
          name="keywords"
          content="Maruti Suzuki Ciaz offer, Nexa Ciaz 2025 Discounts and festive Offers, Ciaz premium sedan deal, Nexa Ciaz savings, 2025 Discounts and festive Offers car sale  .  "
        />
        ...
        <meta
          ...
          content="Discover premium style and comfort with Maruti Suzuki Ciaz. Take advantage of exclusive 2025 year offers on this sophisticated sedan, available only at Nexa showrooms. Drive luxury home today with special discounts!"
        />
        <meta
          property="og:image"
...
const Colors = () => {
  ...
  const data = [
    {
      img: "https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/ciaz/banner/5.webp",
      colorName: "NEXA Blue (Celestial)",
    },
    {
      img: "https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/ciaz/banner/6.webp",
      colorName: "Pearl Metallic Dignity Brown",
    },
    {
      img: "https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/ciaz/banner/_7.webp",
      colorName: "Pearl Midnight Black",
    },
    {
      img: "https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/ciaz/banner/3.webp",
      colorName: "Grandeur Grey",
    },
    {
      img: "https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/ciaz/banner/2.webp",
      colorName: "Splendid Silver",
    },
    {
      img: "https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/ciaz/banner/4.webp",
      colorName: "Opulent Red",
    },
    {
      img: "https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/ciaz/banner/1.webp",
      colorName: "Pearl Arctic White",
    },
    {
      img: "https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/ciaz/banner/pearl-metallic-dignity-brown-and_black.webp",
      colorName: "Pearl Metallic Dignity Brown And Black",
    },
    {
      img: "https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/ciaz/banner/opulent-red-and_black.webp",
      colorName: "Opulent Red And Black",
    },
    {
      img: "https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/ciaz/banner/grandeur-grey-and_black.webp",
    ...
    <>
      ...
      <div className="container relative flex flex-col items-center justify-center mx-auto -mt-10">
        <img
          ...
          src="https://az-ci-cdn-prd-nexa-01.azureedge.net/-/media/feature/nexawebsitecarbrand/scross/safety/desktop/ciazcar-image-webp.webp?la=en&hash=5423464318DC3FB83676641B989760D9"
