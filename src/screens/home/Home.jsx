...
function Home({ setSelected }) {
  ...
  return (
    <div className="relative">
      <Helmet>
        <title>
          Saboo Nexa - Premium Maruti Suzuki Car Dealership in Hyderabad
        </title>
        <meta
          name="title"
        ...
        <meta
          name="keywords"
          content="Saboo Nexa, Nexa cars, Maruti Suzuki Nexa, Nexa dealership Hyderabad, premium cars Hyderabad, Maruti Suzuki cars, Nexa showroom, buy Nexa car, Nexa offers, car dealership Hyderabad"
        />
    ...
    <>
      <div className="relative top-0 left-0 w-full h-[95vh]  sm:h-screen overflow-hidden">
        ...
        <video
          ...
          preload="metadata"
          poster={require("../../assets/HomePageImages/Maruti_Suzuki_Nexa_Strong_Hybrid_Saboo_RKS_Motor_ (1).webp")}
...
const VehicleProducts = () => {
  ...
  return (
    <div className="container px-2 mx-auto lg:pt-4 md:px-3 lg:px-0 xl:max-w-7xl">
      <div className="py-2 mt-2 mb-4 text-3xl font-medium text-left uppercase sm:text-4xl md:text-5xl">
        NEXA CARS
      </div>
      ...
      <Link to="/nexa-car-offers-in-hyderabad">
        <div className="hidden sm:block">
          <img
            ...
            // src={require("../../assets/HomePageImages/Website_Maruti_Suzuki_Nexa_Year_End_Offers_Remember_To_Remember_Offers_Saboo_RKS_Motor_Nexa.webp")}
            // src={require("../../components/Website_Maruti_Suzuki_Nexa_Year_End_Offers_2024_biggest_offers_are_live_at_Saboo_RKS_Motor (1).webp")}
            //  src={require("../../assets/HomePageImages/Website_Maruti_Suzuki_Nexa_October_Festival_Dussehra_Navratri_day_Offers_Saboo_RKS_Nexa.webp")}
            // src="https://images-saboomaruti-in.s3.ap-south-1.amazonaws.com/Nexa+Service+Hafeezpet.webp"
        ...
        {/* <img
          src={require("../../assets/HomePageImages/Maruti_Suzuki_Nexa_Awesome__April_Offers_Saboo_RKS_Motor.webp")}
          // src="https://images-saboomaruti-in.s3.ap-south-1.amazonaws.com/Nexa+Service+Hafeezpet.webp"
          alt="Website_Maruti_Suzuki_Nexa_Monsoon_June_July_Saboo_RKS_Motor_July_Offers"
